...
var severityLevels = ['verbose', 'success', 'log', 'use', 'warn', 'error'];
...
Logger.defaultOptions = {
	...
	successPrefixTheme  : chalk.green.bold,
	successMessageTheme : chalk.green,
	successStream       : process.stdout,
	logPrefix           : '>> ',
	logPrefixTheme      : chalk.cyan.bold,
	logMessageTheme     : chalk.white,
	logStream           : process.stdout,
    usePrefix          : 'Usage: ',
    usePrefixTheme     : chalk.white,
    useMessageTheme    : chalk.white,
    useStream          : process.stdout,
	warnPrefix          : '>> ',
